...
template <typename T>
    ...
    Mesh::Mesh(const std::filesystem::path &gltfAssetPath, int meshIndex) {
        auto assetPath = global_backend->resolve_asset_path(gltfAssetPath);
        ...
        for(const auto &primitive: mesh.primitives) {
            ...
            for(const auto &attrib: primitive.attributes) {
                ...
                // The tinygltf mesh primitives have 3 attribute: POSITION, NORMAL, and TEXCOORD_0.
                // The third is for textures, so we ignore it for now.
                // For more information how to use textures see https://learnopengl.com/Getting-started/Textures.
